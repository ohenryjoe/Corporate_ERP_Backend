...
class DesignationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        model = Designation
        fields = ['id', 'title', 'short_name', 'org_unit', 'is_supervisory', 'employment_type', 'probation_period',
                  'employment_tenure', 'job_summary', 'job_description', 'headed_by', 'max_holders', 'salary_scale',
                  'supervisor']
        # depth = 1
...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Employee
        fields = ['id', 'user', 'surname', 'othernames', 'dob', 'gender', 'salutation', 'nationality', 'marital_status',
                  'profilePic', 'email', 'phone1', 'phone2', 'religion', 'employeeNumber']
...
class ExperienceSerializer(serializers.ModelSerializer):
    class Meta:
        model = Experience
        fields = ['id', 'employee', 'job_title', 'org_name', 'org_website', 'org_telephone', 'org_email', 'description',
                  'from_date', 'to_date']
...
class EducationSerializer(serializers.ModelSerializer):
    class Meta:
        model = Education
        fields = ['id', 'employee', 'qualification_title', 'qualification_title', 'institution_name',
                  'institution_website', 'institution_address', 'institution_email', 'qualification_description',
...
class RelatedPersonSerializer(serializers.ModelSerializer):
    class Meta:
        model = RelatedPerson
        fields = ['id', 'employee', 'full_name', 'gender', 'date_of_birth', 'nin', 'relationship', 'is_nok',
                  'is_dependant', 'email', 'mobile', 'address']
